...
const ModifyProduct = ({onModify, products, productId}) => {
    ...
    const [id] = useState(productToModify.id)
    const [name, setName] = useState(productToModify.name)
    const [description, setDescription] = useState(productToModify.description)
    ...
    const onSubmit = (e) => {
        ...
        onModify({id, name, description, price, category})
        setName('')
        setDescription('')
        setPrice('')
        setCategory('')
